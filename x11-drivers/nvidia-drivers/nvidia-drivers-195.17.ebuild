...
# $Header: /var/cvsroot/gentoo-x86/x11-drivers/nvidia-drivers/nvidia-drivers-195.17.ebuild,v 1.1 2010/02/08 10:27:44 spock Exp $

EAPI="2"

inherit eutils multilib versionator linux-mod flag-o-matic nvidia-driver

X86_NV_PACKAGE="cudadriver_3.0-beta1_linux_32_${PV}"
AMD64_NV_PACKAGE="cudadriver_3.0-beta1_linux_64_${PV}"

DESCRIPTION="NVIDIA X11 driver and GLX libraries"
HOMEPAGE="http://www.nvidia.com/"
SRC_URI="x86? ( http://developer.download.nvidia.com/compute/cuda/3_0-Beta1/drivers/${X86_NV_PACKAGE}-beta.run )
	 amd64? ( http://developer.download.nvidia.com/compute/cuda/3_0-Beta1/drivers/${AMD64_NV_PACKAGE}-beta.run )"
